...
void loadDynparamDefault(){
    system("rosrun dynamic_reconfigure dynparam load /dynparam_server $HOME/TungNV/ros_basic_ws/src/ros_basic/param_pkg/param/param_default.yaml");
    ROS_INFO("control_dynparam.cpp- loadDynparamDefault");
}
void saveDynparamDefault(){
    if(isSaveDynparamDefault){
        system("rosrun dynamic_reconfigure dynparam dump /dynparam_server $HOME/TungNV/ros_basic_ws/src/ros_basic/param_pkg/param/param_default.yaml");
        ROS_INFO("control_dynparam.cpp- saved Dynparam Default");
        isSaveDynparamDefault = false;
    }
}
void loadDynparamRuntime(){
    system("rosrun dynamic_reconfigure dynparam load /dynparam_server $HOME/TungNV/ros_basic_ws/src/ros_basic/param_pkg/param/param_runtime.yaml");
    ROS_INFO("control_dynparam.cpp- loadDynparamRuntime");
}
void saveDynparamRuntime(){
    system("rosrun dynamic_reconfigure dynparam dump /dynparam_server $HOME/TungNV/ros_basic_ws/src/ros_basic/param_pkg/param/param_runtime.yaml");
